...
async function getElement(req, res) {
    try {
        ...
        const element = await getOne(modelName, {
            id: id
        }, req.body);
...
async function editElement(req, res) {
    try {
        ...
        const element = await updateOne(modelName, {
            id: id
        }, req.body);
...
module.exports = postKeywordsController;